...
int main()
{
	setlocale(LC_ALL, "Portuguese");  //Vamos passar para o computador que o comando LC_ALL -> Agente fala pro computador que nossos textos vão estar em portugues
	printf("#### Cartório daa EBAC #### \n\n");
	printf("Digite a opção desejada no menu: \n\n");
	printf("\t1 Registro de nomes \n");
	printf("\t2 Consulta de nomes \n");
	printf("\t3 Deletar nomes \n\n");
	printf("Esse Software é autoria de Luiz Gomez");
}
